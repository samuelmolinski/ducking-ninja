...
$search_page_layout = mb2_theme_option('aquilo_search_page_layout');
$page_content_class = '';
$page_sidebar_class = '';

//check if archive loaded layout from blog page
if($search_page_layout != '') {
	$page_sidebar = get_post_meta ($search_page_layout, 'meta_sidebar', true);
	$page_sidebar_position = get_post_meta ($search_page_layout, 'meta_sidebar_position', true);
	$page_sidebar_name = get_post_meta ($search_page_layout, 'meta_sidebar_name', true);	
}
else {
	$page_sidebar = mb2_theme_option('aquilo_search_page_sidebar');
	$page_sidebar_position = mb2_theme_option('aquilo_search_page_sidebar_position');
	$page_sidebar_name = mb2_theme_option('aquilo_search_page_sidebar_name');	
}
